                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card_dash">
                        ...
                        <div class="card_dash_right">
                            <img src="{{ asset('front') }}/images/dashboard/achievement.svg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card_dash">
                        ...
                        <div class="card_dash_right">
                            <img src="{{ asset('front') }}/images/dashboard/graduation-cap.svg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card_dash">
                        ...
                        <div class="card_dash_right">
                            <img src="{{ asset('front') }}/images/dashboard/online-course.svg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card_dash">
                        ...
                        <div class="card_dash_right">
                            <img src="{{ asset('front') }}/images/dashboard/knowledge.svg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                        ...
                        <div class="la5lo1">
                            <div class="owl-carousel edututs_news owl-theme">
                                <div class="item">
                                    <div class="fcrse_1">
                                        <a href="#" class="fcrse_img">
                                            <img src="{{ asset('front') }}/images/courses/news-1.jpg" alt="">
                                        </a>
                                        <div class="fcrse_content">
                                ...
                                <div class="item">
                                    <div class="fcrse_1">
                                        <a href="#" class="fcrse_img">
                                            <img src="{{ asset('front') }}/images/courses/news-2.jpg" alt="">
                                        </a>
                                        <div class="fcrse_content">
