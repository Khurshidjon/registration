            ...
            <div class="row">
                <div class="col-xl-8 col-lg-8">
                    <div class="section3125">
                        <div class="live1452">
                            <iframe src="https://www.youtube.com/embed/rbwICMG81is" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="user_dt5">
                ...
                <div class="col-md-12">
                    <div class="section3125 mb-15 mt-20">
                        ...
                        <a href="{{ route('front.live-streams') }}" class="see150">Barchasini ko'rish</a>
                        <div class="la5lo1">
