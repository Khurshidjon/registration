@extends('layouts.app')
@section('content')
@section('title', 'Saqlangan kurslar')
    <div class="sa4d25">
                    ...
                    <div class="_14d25 mb-20">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="fcrse_1">
                                    <a href="{{ route('front.show') }}" class="hf_img">
                                        <img src="{{ asset('front') }}/images/courses/img-1.jpg" alt="">
                                    ...
                                    <div class="hs_content">
                                        ...
                                        <a href="{{ route('front.show') }}" class="crse14s title900">Complete Python Bootcamp: Go from zero to hero in Python 3</a>
                                ...
                                <div class="fcrse_1 mt-30">
                                    ...
                                    <div class="hs_content">
                                        ...
                                        <a href="{{ route('front.show') }}" class="crse14s title900">The Complete JavaScript Course 2020: Build Real Projects!</a>
                                ...
                                <div class="fcrse_1 mt-30">
                                    ...
                                    <div class="hs_content">
                                        ...
                                        <a href="{{ route('front.show') }}" class="crse14s title900">Beginning C++ Programming - From Beginner to Beyond</a>
                                ...
                                <div class="fcrse_1 mt-30">
                                    ...
                                    <div class="hs_content">
                                        ...
                                        <a href="{{ route('front.show') }}" class="crse14s title900">The Complete Digital Marketing Course - 12 Courses in 1</a>
