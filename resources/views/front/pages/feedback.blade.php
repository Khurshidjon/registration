@extends('layouts.app')
@section('content')
@section('title', 'Fikr va mulohazalar bildirish')

    <div class="sa4d25">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="st_title"><i class="uil uil-comment-info-alt"></i> Fikr va mulohazalaringizni yuboring</h2>
                    <div class="row">
                        <div class="col-lg-6 col-md-8">
                            ...
                            <button class="save_btn" type="submit">Yuborish</button>
                        </div>
                    </div>
                </div>
            </div>
