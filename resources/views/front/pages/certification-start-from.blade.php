                            ...
                            <div class="ttl121">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('front.certification-center') }}">Sertifikatlashtirish markazi</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Sertifikat to'ldirish shakli</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                        <div class="titleright">
                            <a href="{{ route('front.certification-center') }}" class="blog_link"><i class="uil uil-angle-double-left"></i>Sertifkatlash markaziga qaytish</a>
                        </div>
                    </div>
                    <div class="title126">
                        <h2>Sertifikat formasi</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-lg-center justify-content-md-center">
                <div class="col-lg-6 col-md-8">
                    <div class="certi_form">
                        <div class="sign_form">
                            <h2>Boshlashdan oldin to'ldiring:</h2>
                            <form>
                                <div class="ui search focus mt-40">
                                    <div class="ui left icon input swdh11 swdh19">
                                        <input class="prompt srch_explore" type="text" name="fullname" value="" id="id_fullname" required="" maxlength="64" placeholder="To'liq ism familiya">
                                    </div>
                                </div>
                                <div class="ui search focus mt-15">
                                    <div class="ui left icon input swdh11 swdh19">
                                        <input class="prompt srch_explore" type="email" name="emailaddress" value="" id="id_email" required="" maxlength="64" placeholder="Elektron pochta manzili">
                                    </div>
                                </div>
                                <div class="ui search focus mt-15">
                                    <div class="ui left icon input swdh11 swdh19">
                                        <input class="prompt srch_explore" type="text" name="phonenumber" value="" id="id_phonenumber" required="" maxlength="10" placeholder="Telefon raqam">
                                    </div>
                                </div>
                                <div class="category_cop">
                                    <h4>Kategoriyani tanlang</h4>
                                ...
                                <button class="login-btn" type="submit">Qani boshladik</button>
                            </form>
