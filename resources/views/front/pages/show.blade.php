...
{{--                    <iframe  src="https://www.youtube.com/embed/Ohe_JzKksvA" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>--}}
                    <iframe  src="https://www.youtube.com/embed/IpN3VffwZQQ" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6">
                                <div class="preview_video">
                                    <a href="#" class="fcrse_img" data-toggle="modal" data-target="#videoModal">
                                        <img src="{{ asset('front') }}/images/courses/Screenshot_2.png" alt="">
                                        <div class="course-overlay">
                                            <div class="badge_seller">IT sohasi</div>
                                            <span class="play_btn1"><i class="uil uil-play"></i></span>
                                            <span class="_215b02">Ushbu kursni oldindan ko'rib chiqing</span>
                                        </div>
                                    </a>
                                </div>
                                <div class="_215b10">
                                    <a href="#" class="_215b11">
                                        <span><i class='uil uil-heart-alt'></i></span>Tanlanganlar ro'yxati
                                    </a>
                                    <a href="#" class="_215b12">
                                        <span><i class="uil uil-windsock"></i></span>Shikoyat qilish
                                    </a>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-7 col-md-6">
                                <div class="_215b03">
                                    <h2>MS Office dasturlarida ishlash</h2>
                                    <span class="_215b04">Ushbu kurs orqali siz: Word, Excel, Power Point, MS Access, Publisher dasturlarida ishlashni o'rganishingiz mumkin</span>
                                </div>
                                <div class="_215b05">
                                ...
                                <div class="_215b05">
                                    114,521 o'quvchi ro'yxatdan o'tgan
                                </div>
                                <div class="_215b06">
                                    <div class="_215b07">
                                ...
                                <div class="_215b05">
                                    So'nggi yangilanish 26/10/2020
                                </div>
                                <ul class="_215b31">
                                    <li><button class="btn_adcart"><i class="fas fa-download"></i> Yuklab olish</button></li>
                                    <li><button class="btn_buy"><i class="fas fa-share"></i> Ulashish</button></li>
                                </ul>
                                <div class="_215fgt1">
                                    Yuqori natijali sertifikat olganda, ish bilan oson ta'minlanish kafolati
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="user_dt5">
                        <div class="user_dt_left">
                            <div class="live_user_dt">
                                <div class="user_img5">
                                    <a href="#"><img src="{{ asset('front') }}/images/left-imgs/img-1.jpg" alt=""></a>
                                </div>
                                <div class="user_cntnt">
                                    <a href="#" class="_df7852">Ergashev Xurshid</a>
                                    <button class="subscribe-btn">Obuna bo'lish</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="course_tabs">
                        <nav>
                            <div class="nav nav-tabs tab_crse justify-content-center" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-selected="true">Kurs haqida</a>
                                <a class="nav-item nav-link" id="nav-courses-tab" data-toggle="tab" href="#nav-courses" role="tab" aria-selected="false">Kurs xaritasi</a>
                                <a class="nav-item nav-link" id="nav-reviews-tab" data-toggle="tab" href="#nav-reviews" role="tab" aria-selected="false">Sharhlar</a>
                            </div>
                        </nav>
                    </div>
                </div>
