@extends('layouts.app')
@section('content')
@section('title', 'Jonli muloqotlar')
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="section3125">
                    <h4 class="item_title">Barcha jonli efirdagilar</h4>
                    <div class="la5lo1">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="stream_1 mb-30">
                                    <a href="{{ route('front.live-output') }}" class="stream_bg">
                                        <img src="{{ asset('front') }}/images/left-imgs/img-11.jpg" alt="">
                            ...
                            <div class="col-md-3">
                                <div class="stream_1 mb-30">
                                    <a href="{{ route('front.live-output') }}" class="stream_bg">
                                        <img src="{{ asset('front') }}/images/left-imgs/img-12.jpg" alt="">
                                        <h4>Eli Natoli</h4>
                                        <p>live<span></span></p>
                                    </a>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="stream_1 mb-30">
                                    <a href="{{ route('front.live-output') }}" class="stream_bg">
                                        <img src="{{ asset('front') }}/images/left-imgs/img-13.jpg" alt="">
                            ...
                            <div class="col-md-3">
                                <div class="stream_1 mb-30">
                                    <a href="{{ route('front.live-output') }}" class="stream_bg">
                                        <img src="{{ asset('front') }}/images/left-imgs/img-14.jpg" alt="">
                                        <h4>Farhat Amin</h4>
                                        <p>live<span></span></p>
                                    </a>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="stream_1 mb-30">
                                    <a href="{{ route('front.live-output') }}" class="stream_bg">
                                        <img src="{{ asset('front') }}/images/left-imgs/img-15.jpg" alt="">
                                        <h4>Kyle Pew</h4>
                                        <p>live<span></span></p>
                                    </a>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="stream_1 mb-30">
                                    <a href="{{ route('front.live-output') }}" class="stream_bg">
                                        <img src="{{ asset('front') }}/images/left-imgs/img-16.jpg" alt="">
                                        <h4>Kerstin Cable</h4>
                                        <p>live<span></span></p>
                                    </a>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="stream_1 mb-30">
                                    <a href="{{ route('front.live-output') }}" class="stream_bg">
                                        <img src="{{ asset('front') }}/images/left-imgs/img-17.jpg" alt="">
                                        <h4>Jose Portilla</h4>
                                        <p>live<span></span></p>
                                    </a>
                                </div>
